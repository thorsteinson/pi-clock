...
var args10237 = [];
var len__8301__auto___10241 = arguments.length;
var i__8302__auto___10242 = (0);
while(true){
if((i__8302__auto___10242 < len__8301__auto___10241)){
args10237.push((arguments[i__8302__auto___10242]));

var G__10243 = (i__8302__auto___10242 + (1));
i__8302__auto___10242 = G__10243;
continue;
} else {
}
break;
...
var G__10240 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__10240,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__10240;
}
});
...
var len__8301__auto___10248 = arguments.length;
var i__8302__auto___10249 = (0);
while(true){
if((i__8302__auto___10249 < len__8301__auto___10248)){
args__8308__auto__.push((arguments[i__8302__auto___10249]));

var G__10250 = (i__8302__auto___10249 + (1));
i__8302__auto___10249 = G__10250;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq10245){
var G__10246 = cljs.core.first.call(null,seq10245);
var seq10245__$1 = cljs.core.next.call(null,seq10245);
var G__10247 = cljs.core.first.call(null,seq10245__$1);
var seq10245__$2 = cljs.core.next.call(null,seq10245__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__10246,G__10247,seq10245__$2);
});
...
var file = cljs.core.get.call(null,map__10254__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__10254__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__10254__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__10254,map__10254__$1,file,line,column){
return (function (p1__10251_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__10251_SHARP_));
});})(map__10254,map__10254__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__8111__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__8111__auto__,prefer_table__8112__auto__,method_cache__8113__auto__,cached_hierarchy__8114__auto__,hierarchy__8115__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__7085__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__7085__auto__)){
return or__7085__auto__;
} else {
...
var temp__6753__auto___10256 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__6753__auto___10256)){
var message_10257 = temp__6753__auto___10256;
cljs.core.println.call(null,message_10257);
} else {
}
...
var temp__6753__auto___10258 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__6753__auto___10258)){
var message_10259 = temp__6753__auto___10258;
cljs.core.println.call(null,message_10259);
} else {
}
...
var G__10269 = exception.stack;
var G__10269__$1 = (((G__10269 == null))?null:clojure.string.split_lines.call(null,G__10269));
var G__10269__$2 = (((G__10269__$1 == null))?null:cljs.core.get.call(null,G__10269__$1,depth));
if((G__10269__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__10269__$2);
}
} else {
...
var vec__10270 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__10270,(0),null);
var column = cljs.core.nth.call(null,vec__10270,(1),null);
var vec__10273 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__10273,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__10273,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__10273,(2),null);
...
var m__$1 = (function (){var G__10277 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__10277) {
case "fail":
...
var G__10283 = (function (){var G__10282 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__10282);
} else {
return G__10282;
}
})();
...
return cljs.core.vary_meta.call(null,G__10285,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e10288){var e = e10288;
var G__10289 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__10289) {
...
var vec__10294 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__10294,(0),null);
var types = vec__10294;
...
return cljs.core.map.call(null,(function (p__10306){
var vec__10307 = p__10306;
var ns = cljs.core.nth.call(null,vec__10307,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__10307,(1),null);
return ((function (vec__10307,ns,vars__$1){
return (function (){
...
var G__10310 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__10310) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__10310,env,once_fixtures,each_fixtures,vec__10307,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__10310,env,once_fixtures,each_fixtures,vec__10307,ns,vars__$1){
return (function (){
var seq__10311 = cljs.core.seq.call(null,vars__$1);
var chunk__10312 = null;
var count__10313 = (0);
var i__10314 = (0);
while(true){
if((i__10314 < count__10313)){
var v = cljs.core._nth.call(null,chunk__10312,i__10314);
var temp__6753__auto___10316 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__6753__auto___10316)){
var t_10317 = temp__6753__auto___10316;
each_fixture_fn.call(null,((function (seq__10311,chunk__10312,count__10313,i__10314,t_10317,temp__6753__auto___10316,v,each_fixture_fn,G__10310,env,once_fixtures,each_fixtures,vec__10307,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10317)));
});})(seq__10311,chunk__10312,count__10313,i__10314,t_10317,temp__6753__auto___10316,v,each_fixture_fn,G__10310,env,once_fixtures,each_fixtures,vec__10307,ns,vars__$1))
);
} else {
}

var G__10318 = seq__10311;
var G__10319 = chunk__10312;
var G__10320 = count__10313;
var G__10321 = (i__10314 + (1));
seq__10311 = G__10318;
chunk__10312 = G__10319;
count__10313 = G__10320;
i__10314 = G__10321;
continue;
} else {
var temp__6753__auto__ = cljs.core.seq.call(null,seq__10311);
if(temp__6753__auto__){
var seq__10311__$1 = temp__6753__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__10311__$1)){
var c__7991__auto__ = cljs.core.chunk_first.call(null,seq__10311__$1);
var G__10322 = cljs.core.chunk_rest.call(null,seq__10311__$1);
var G__10323 = c__7991__auto__;
var G__10324 = cljs.core.count.call(null,c__7991__auto__);
var G__10325 = (0);
seq__10311 = G__10322;
chunk__10312 = G__10323;
count__10313 = G__10324;
i__10314 = G__10325;
continue;
} else {
var v = cljs.core.first.call(null,seq__10311__$1);
var temp__6753__auto___10326__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__6753__auto___10326__$1)){
var t_10327 = temp__6753__auto___10326__$1;
each_fixture_fn.call(null,((function (seq__10311,chunk__10312,count__10313,i__10314,t_10327,temp__6753__auto___10326__$1,v,seq__10311__$1,temp__6753__auto__,each_fixture_fn,G__10310,env,once_fixtures,each_fixtures,vec__10307,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10327)));
});})(seq__10311,chunk__10312,count__10313,i__10314,t_10327,temp__6753__auto___10326__$1,v,seq__10311__$1,temp__6753__auto__,each_fixture_fn,G__10310,env,once_fixtures,each_fixtures,vec__10307,ns,vars__$1))
);
} else {
}

var G__10328 = cljs.core.next.call(null,seq__10311__$1);
var G__10329 = null;
var G__10330 = (0);
var G__10331 = (0);
seq__10311 = G__10328;
chunk__10312 = G__10329;
count__10313 = G__10330;
i__10314 = G__10331;
continue;
}
} else {
...
});})(each_fixture_fn,G__10310,env,once_fixtures,each_fixtures,vec__10307,ns,vars__$1))
);
});})(each_fixture_fn,G__10310,env,once_fixtures,each_fixtures,vec__10307,ns,vars__$1))
], null);
